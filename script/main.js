...
// Function for setting a random song
  ...
  if (random == 1) {
    ...
    songname.innerHTML = "Mazza L20 - Plugged In w/ Fumez The Engineer | Mixtape Madness";
  }
  else if (random == 2) {
    document.getElementById("loading").src = "song/song2.mp3";
    songname.innerHTML = "#ACTIVEGXNG SUS X T.SCAM - THE HOTSPOT";
  }
  else if (random == 3) {
    document.getElementById("loading").src = "song/song3.mp3";
    songname.innerHTML = "Suspect (AGB) - Freestyle";
  }
